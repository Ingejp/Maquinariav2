...
} = useCatalogPage('/configuracion/tipos-maquinaria');
</script>
...
<template>
    <main class="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        <div class="mb-6">
            ...
            <h1 class="font-display text-2xl font-semibold text-text">Tipos de maquinaria</h1>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_300px]">
            <CatalogTable :items="items" :loading="loading" empty-message="No hay tipos de maquinaria registrados." @edit="startEdit" @toggle="toggleStatus" @delete="askDelete">
                <template #head>
